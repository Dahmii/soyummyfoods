...
export function AdminDashboardPage() {
  ...
  return (
    <section>
      ...
      <div className="mt-6 flex flex-wrap gap-3"><Button asChild><Link to="/admin/catalog/products">Manage products</Link></Button><Button asChild variant="outline"><Link to="/admin/catalog/categories">Manage categories</Link></Button><Button asChild variant="outline"><Link to="/admin/inventory">Inventory</Link></Button><Button asChild variant="outline"><Link to="/admin/orders">Orders</Link></Button><Button asChild variant="outline"><Link to="/admin/delivery-zones">Delivery zones</Link></Button><Button asChild variant="outline"><Link to="/admin/settings/business">Business settings</Link></Button></div>
    </section>
  );
}
